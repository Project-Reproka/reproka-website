...
export default function LangSwitchListItm({ language, item, selected, select }) {
  ...
  return (
    <div className="flex flex-row gap-2 items-center py-2 px-2 justify-between border-[#303053] bg-[rgba(127,127,255,2%)] border rounded-md" style={{borderColor: (selected ? '#22ff77' : ''), background: (selected ? 'rgba(127,255,127,10%)' : '')}}>
